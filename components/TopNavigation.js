            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                <Tab.Group as="div" className="mt-2">
                  <div className="border-b border-gray-200">
                    <Tab.List className="-mb-px flex space-x-8 px-4">
                      {blok.global[0].category.map((category, i) => (
                        <Tab
                          key={i}
                          className={({ selected }) =>
                            classNames(
                    ...
                    {blok.global[0].category.map((category, i) => (
                      <Tab.Panel key={i} className="space-y-10 px-4 pb-8 pt-10">
                        <div className="grid grid-cols-2 gap-x-4">
                          {category.featured.map((item, j) => (
                            <div key={j} className="group relative text-sm">
                              <div className="aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75">
                                <img src={item.src} alt={item.alt} className="object-cover object-center" />
                              </div>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  {blok.global[1].pages.map((page, i) => (
                                ...
                                <div className="mx-auto max-w-7xl px-8">
                                  <div className="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                                    <div className="col-start-2 grid grid-cols-2 gap-x-8">
                                      {category.featured.map((item, j) => (
                                        <div key={j} className="group relative text-base sm:text-sm">
                                          <div className="aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75">
                                            <img
                                              src={item.src}
                                              alt={item.alt}
