      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="py-20 xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-4 gap-8 xl:col-span-2">
            {blok.global.map((section, i) => {
              return (
                <div className="space-y-16 md:grid md:grid-cols-2 md:gap-8 md:space-y-0" key={i}>
                  <div>
                    <h3 className="text-sm font-medium text-gray-900">{section.headline}</h3>
